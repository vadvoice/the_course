# Stage 0 Task Brief — Vanilla JavaScript Foundation (Optional)
...
## Deliverables
- Repo structure: `stage-0/core/` for the Pantry Explorer, `stage-0/lab/` for the animation drill.
...
**Navigation:** [Stage 0 Overview](topics.md) · [Stage 1: React Basics](../1/topics.md) · [Program Overview](../../README.md)

...
- **Git Flow workflow**: All code submitted via feature branches with pull/merge requests. Final release via `release/*` branch merged to `main` (see [Git Flow guide](../assets/gitflow-workflow.md)).
...
- Internal assets: [`gitflow-workflow.md`](../assets/gitflow-workflow.md), [`deploy-checklist-template.md`](../assets/week3/deploy-checklist-template.md), [`dashboard-data-flow.md`](../assets/week3/dashboard-data-flow.md).
